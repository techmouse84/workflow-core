...
namespace WorkflowCore.Interface
{
    ...
    {
        Task<string> StartWorkflow(string workflowId, int? tenantId, object data = null);
        Task<string> StartWorkflow(string workflowId, int? tenantId, int? version, object data = null);
        Task<string> StartWorkflow<TData>(string workflowId, int? tenantId, TData data = null) where TData : class;
        Task<string> StartWorkflow<TData>(string workflowId, int? tenantId, int? version, TData data = null) where TData : class;
